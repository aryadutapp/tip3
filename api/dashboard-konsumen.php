...
<html>
    ...
    <script>
        ...
        function createTableRow(data) {
            ...
            <button type="button" data-modal-target="pesanan_masuk_konsumen" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none" onclick="openModal('pesanan_masuk_konsumen')">
    Pesan Tempat
</button>
                ...
                <script>
                    function handleSubmit(event) {
                        ...
                        .then(data => {
                            if (data.status_pesanan_masuk === 'success') {
                                // Display success message as a popup
                                alert('Pesanan berhasil masuk!. Tekan OK untuk kembali ke halaman utama');
                                // jika pesanan konsumen berahasi, kembali ke halaman utama
