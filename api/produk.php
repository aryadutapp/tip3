    ...
    <header>
        <nav>
          ...
          <section id="banner-customer" class="overflow-hidden lg:py-20 sm:py-32 lg:pb-32 xl:pb-36">
              <div class="mx-auto w-full max-w-7xl lg:px-8"><div class="relative px-4 sm:px-8 lg:px-12"><div class="mx-auto max-w-2xl lg:max-w-5xl"><header class="max-w-2xl"><h1 class="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">Titip barang gak harus ribet</h1><p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">Dengan Titip.in, kalian dapat langsung titip barang dengan mitra kami baik melalui website atau langsung ke jaringan mitra kami.</p></header><div class="mt-16 sm:mt-20"><ul role="list" class="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3"><li class="group relative flex flex-col items-start"><h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100"><div class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-2xl"></div><a href="http://planetaria.tech"><span class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span class="relative z-10">Penitipan tanpa registrasi</span></a></h2><p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Dengan fitur ini kamu dapat langsung menitipkan barang tanpa melalui registrasi. Nanti ketika di mitra kamu akan mendapatkan kode pengambilan untuk mengambil barang</p></li><li class="group relative flex flex-col items-start"><h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100"><div class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-2xl"></div><a href="#"><span class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span class="relative z-10">Penitipan melalui website</span></a></h2><p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Dengan fitur ini, kamu dapat memilih penitipan dengan memilih lokasi mitra titip.in melalui website kami</p></li><li class="group relative flex flex-col items-start"><h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100"><a href="#"><span class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span class="relative z-10">Kode pengambilan</span></a></h2><p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Kode pengambilan digunakan untuk mengambil barang untuk memastikan hanya kamu yang bisa ambil barangmu dan bukan orang lain</p></li><li class="group relative flex flex-col items-start"><h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100"><a href="#"><span class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span class="relative z-10">Riwayat transaksi</span></a></h2><p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Riwayat transaksi untuk memastikan mitra kami dapat mencatat riwayat transaski dan keuangan mitra</p></li></ul></div></div></div></div>
            </section>
