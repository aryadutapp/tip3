...
<html>
            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 -translate-x-full" aria-label="Sidebar" aria-hidden="true">
                <div class="mt-20 h-full px-3 py-4 overflow-y-auto bg-gray-50">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="dashboard-mitra.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-300 group">
                        ...
                        <li>
                            <a href="./riwayat-mitra.php" class="flex items-center p-2 text-gray-900 rounded-lg bg-gray-100 group">
    ...
    <script>
        ...
        fetchReservationData();
                    ...
                    <section id="riwayat-pesanan-keluar" class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
            <div class="mx-auto">
            <div class="rounded-t-lg bg-gray-100 p-6">
            <h2 class="text-2xl font-bold mb-4 text-black">Riwayat Pesanan Keluar</h2>
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <!-- Start coding here -->
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            <!-- // buat search bar-->
