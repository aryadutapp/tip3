                      ...
                      <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6 mb-6" action="./controllers.php?action=register" onsubmit="return handleKeluar(event);" method="post"> 
                          <div class="relative w-full">
                            ...
                            <input type="text" id="full-id-search" name="pickup_number" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2" placeholder="Cari Nama Pemilik" required="">
