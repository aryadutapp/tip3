  ...
  <section class="pages-signup pb-10">
    <div class="flex items-center justify-center">
      <div class="max-w-md w-full px-6 py-8 bg-white rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold text-center text-gray-800 mb-5">Daftar Konsumen</h2>
<p class="text-md text-gray-700 text-center">Daftar sebagai Mitra ? <a class="text-yellow-500 hover:text-yellow-800 mb-4 font-semibold" href="./daftar-mitra.php">Klik Disini</a></p>
